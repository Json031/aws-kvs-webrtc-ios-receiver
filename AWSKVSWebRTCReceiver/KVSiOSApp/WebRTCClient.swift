...
final class WebRTCClient: NSObject {
    ...
    required init(iceServers: [RTCIceServer], isAudioOn: Bool) {
        ...
        //注册一个观察者，以此来监听音频会话路由变更的通知
        NotificationCenter.default.addObserver(forName: NSNotification.Name.AVAudioSessionRouteChange, object: nil, queue: nil, using: onRouteChange)
    }
...
extension WebRTCClient: RTCDataChannelDelegate {
    ...
    //监听音频会话路由变更的通知，当路由变更时重置为speaker扬声器播放
