...
class ChannelConfigurationViewController: UIViewController, UITextFieldDelegate {
    ...
    var awsCredentials : AWSStaticCredentialsProvider = AWSStaticCredentialsProvider(accessKey: AWSAccessKey, secretKey: AWSSecretKey)
    ...
    override func viewDidLoad() {
        ...
        self.channelName.text = DefaultChannel
        self.regionName.text = DefaultRegionName
    }
    ...
    func connectAsRole() {
        ...
        let configuration = AWSServiceConfiguration(region: awsRegionType, credentialsProvider: self.awsCredentials)
        ...
        */
        let configuration =
            AWSServiceConfiguration(region: regionType,
                                    endpoint: endpoint,
                                    credentialsProvider: self.awsCredentials)
